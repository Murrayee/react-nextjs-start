...
class Footer extends React.Component {
  ...
  render() {
    ...
    const dataSource = [
      {
        ...
        content: 'https://zos.alipayobjects.com/rmsportal/IiCDSwhqYwQHLeU.svg\n https://zos.alipay' +
            'objects.com/rmsportal/AXtqVjTullNabao.svg\n https://zos.alipayobjects.com/rmspor' +
            'tal/fhJykUTtceAhYFz.svg\n https://zos.alipayobjects.com/rmsportal/IDZTVybHbaKmoE' +
            'A.svg',
        contentLink: '#\n#\n#\n#'
      }
    ];
    ...
    return (
      <OverPack {...props} playScale={isMobile
        ? 0.5
        : 0.2}>
        <QueueAnim
          type="bottom"
        ...
        <TweenOne
          ...
          id={`${props.id}-content`}>
          <span>
            Copyright © 2016 The Project by
            <a href="#">Ant Motion</a>. All Rights Reserved
          </span>
        </TweenOne>
      </OverPack>
    );
